...
export class GrapletLocalStorage {
  ...
  public static async addProject(project: Project): Promise<string> {
      ...
      return new Promise<string>((resolve, reject) => {
          ...
          request.onerror = (event) => {
              console.error("Failed to add project:", (event.target as IDBRequest).error)
  ...
  public static async getProject(id: string): Promise<Project | undefined> {
      ...
      return new Promise<Project | undefined>((resolve, reject) => {
          ...
          request.onerror = (event) => {
              console.error("Failed to retrieve project:", (event.target as IDBRequest).error)
  ...
  public static async updateProject(id: string, updateData: Partial<Project>): Promise<void> {
      ...
      return new Promise<void>((resolve, reject) => {
          ...
          request.onerror = (event) => {
              console.error("Failed to update project:", (event.target as IDBRequest).error)
  ...
  public static async deleteProject(id: string): Promise<void> {
      ...
      return new Promise<void>((resolve, reject) => {
          ...
          request.onerror = (event) => {
              console.error("Failed to delete project:", (event.target as IDBRequest).error)
  ...
  public static async listProjects(): Promise<Project[]> {
      ...
      return new Promise<Project[]>((resolve, reject) => {
          ...
          request.onerror = (event) => {
              console.error("Failed to list projects:", (event.target as IDBRequest).error)
